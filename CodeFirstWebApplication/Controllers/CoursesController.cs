...
namespace CodeFirstWebApplication.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseID,Title,Creadits")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseID,Title,Creadits")] Course course)
        {
            if (ModelState.IsValid)
            {
